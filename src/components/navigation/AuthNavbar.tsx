...
import { landingLinks } from "@/components/navigation/authNavbar.data";
...
export function AuthNavbar() {
  ...
  return (
    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 rounded-lg border border-white/10 bg-white/[0.06] px-4 py-3 shadow-command backdrop-blur-2xl">
        <Link
          to={paths.landing}
